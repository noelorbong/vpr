                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="(data) in searchResult" :key="data.id">
                                    <td @click="goToProfile(data.id)" style="cursor:pointer" >{{data.plate_no}}</td>
                                    <td @click="goToProfile(data.id)" style="cursor:pointer">{{data.make}}</td>
                                    ...
                                    <td @click="goToProfile(data.id)" style="cursor:pointer">{{data.or_date}}</td>
                                    <td @click="goToProfile(data.id)" style="cursor:pointer">{{data.expiration_date}}</td>

                                    <td align="right">
                                        <router-link :to="{name: 'VehicleEdit' , params: {id: data.id}}" class="btn btn-orange  btn-sm">
