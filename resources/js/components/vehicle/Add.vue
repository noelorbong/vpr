...
<div>
    <div class="card">
        <div class="card-header">
            <i class="nav-icon fa fa-plus"></i> Register Vehicles
        </div>
            ...
            <form autocomplete="off" v-on:submit="saveForm()">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" v-on:keyup="showMembers" v-model="data.owners_full_name" required>
                        <input type="hidden" v-model="data.owners_name">
                    </div>
                    <!-- <div class="form-group col-md-6">
                        <label for="exampleFormControlInput1">Owner's Number</label>
                        <input type="text" class="form-control" v-model="data.owners_number">
                    </div>
                    <div class="form-group col-md-12">
...
export default {
    ...
    methods: {
        ...
        saveForm() {
            ...
            axios
                .post("/vehicle/store", data)
                .then(function (resp) {
                    console.log(resp);
                    if(resp.data == 'failed'){
                         alert("Could not Register: Plate number exist!");
                    }else {
                        app.$router.push("/vehicle/list");
                    }
                })
                .catch(function (resp) {
                    console.log(resp);
        ...
        showMembers() {
            ...
            app.inputSearchMessage = app.data.owners_full_name;
            app.memberList();
        ...
        selectOwner(data) {
            ...
            app.data.owners_full_name = data.full_name;
            app.hide();
        },
        memberList() {
            var app = this;
