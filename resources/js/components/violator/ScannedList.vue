                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="(data) in searchResult" :key="data.id">
                                    ...
                                    <td align="right">
                                        <router-link :to="{name: 'ViolatorScannedEdit' , params: {id: data.id}}" class="btn btn-orange  btn-sm">
    ...
    methods: {
        ...
        deleteEntry(id) {
            if (confirm("Do you really want to delete it?")) {
                var app = this;
                axios
                    .delete("/violator/scanned/delete/" + id)
                    .then(function (resp) {
