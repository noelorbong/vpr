                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="(data) in searchResult" :key="data.missing_vehicles_id">
                                    <td>{{data.plate_no}}</td>
                                    <td>{{data.make}}</td>
                                    <td>{{data.full_name}}</td>
                                    <td>{{data.date_missing}}</td>
                                    <td>{{data.date_found}}</td>
                                    <td>{{data.missing_note}}</td>
                                    <td>{{data.found_note}}</td>
                                    <td align="right">
