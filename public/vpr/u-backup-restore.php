								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12 pb-5">
                                            ...
                                            <button type="button" class="btn btn-primary btn-gradient btn-sm" data-toggle="modal" data-target="#exampleModalCenter">BACK-UP DATABASE</button>
                                            ...
                                            <div class="table-responsive">
												<table id="datatable-1" class="table table-datatable table-striped table-hover">
                                                    ...
                                                    <thead>
														<tr>
															<th>Back-up File Name</th>
                                                            <th>Location</th>
                                                            <th>Date & Time Back-up</th>
                                                            <th>&nbsp</th>
														</tr>
													</thead>
													<tbody>
														<tr>
                                                            ...
                                                            <td>Date Time</td>
                                                            <td align="right">
                                                                <button type="button" class="btn btn-yellow active btn-sm" >Restore</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Back-up Database</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Back-up</button>
                </div>
            </div>
        </div>
    </div>
