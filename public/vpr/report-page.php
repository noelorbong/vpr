								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12 pb-5">
                                            ...
                                            <div class="col-lg-6">
                                                From
                                                <input type="text" class="date form-control" autocomplete="off" placeholder="DD/MM/YYYY">
                                            </div>
                                            <div class="col-lg-6">
                                                To
                                                <input type="text" class="date form-control" autocomplete="off" placeholder="DD/MM/YYYY">
												...
												<table id="datatable-1" class="table table-datatable table-striped table-hover">
													...
													<tbody>
														<tr>
                                                            ...
                                                            <td>$150,000,000</td>
                                                            <td>
                                                                <button type="button" class="btn btn-primary btn-gradient btn-sm">Print</button>
                                                            </td>
														</tr
													</tbody>
												</table>
                                                <button type="button" class="btn btn-primary btn-gradient btn-md" style="float: right">Print ALl</button>
