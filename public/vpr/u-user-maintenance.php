...
<body>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12 pb-5">
                                            ...
                                            <button type="button" class="btn btn-primary btn-gradient btn-sm" data-toggle="modal" data-target="#exampleModalCenter">ADD NEW USER</button>
                                                    ...
                                                    if($objectMaintenance->selectAllRecords("tbl_user_info") != 0) {
                                                        foreach ($objectMaintenance->selectAllRecords("tbl_user_info") as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php print $value["info_lastname"]?></td>
                                                                <td><?php print $value["info_firstname"]?></td>
                                                                <td><?php print $value["info_middlename"]?></td>
                                                                <td><?php print $value["info_contact"]?></td>
                                                                <td><?php print $value["info_bdate"]?></td>
                                                                <td><?php print $value["info_address"]?></td>
                                                                <td align="right">
                                                                    <button onclick="editUserInfo(<?php print $value["id"]?>)" type="button" class="btn btn-orange btn-gradient btn-sm" >Edit</button>
                                                                    <button onclick="deleteUserInfo(<?php print $value["id"]?>)" type="button" class="btn btn-danger active btn-sm">Delete</button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="txtContactNumber">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="addUserInfo()" class="btn btn-primary">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Last Name</label>
                            <input type="text" class="form-control" id="txtLastnameUpdate">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlInput1">First Name</label>
                            <input type="text" class="form-control" id="txtFirstnameUpdate">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlInput1">Middle Name</label>
                            <input type="text" class="form-control" id="txtMiddlenameUpdate">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlInput1">Contact Number</label>
                            <input type="number" class="form-control" id="txtContactNumberUpdate">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlInput1">Birth Date</label>
                            <input type="date" class="form-control" id="txtBirthdateUpdate">
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button onclick="updateUserInfo()" class="btn btn-primary">Save changes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function addUserInfo(){
            var txtFnamme = document.getElementById("txtFirstname").value;
            var txtLname = document.getElementById("txtLastname").value;
            var txtMname = document.getElementById("txtMiddlename").value;
            var txtContact = document.getElementById("txtContactNumber").value;
            var txtBdate = document.getElementById("txtBirthdate").value;
            var txtAddress = document.getElementById("txtAddress").value;

            $.ajax({
                method: "GET",
                url: "ajax-insert-maitenance.php",
                data: {fname: txtFnamme, lname: txtLname, mname: txtMname, contact: txtContact, bdate: txtBdate, address: txtAddress, action: 'user-add'},
                success: function(){
                    alert("Success");
                    location.reload();
                }
    ...
    <script>
        ...
        function updateUserInfo() {
            ...
            var txtFnamme = document.getElementById("txtFirstnameUpdate").value;
            var txtLname = document.getElementById("txtLastnameUpdate").value;
            var txtMname = document.getElementById("txtMiddlenameUpdate").value;
            var txtContact = document.getElementById("txtContactNumberUpdate").value;
            var txtBdate = document.getElementById("txtBirthdateUpdate").value;
            var txtAddress = document.getElementById("txtAddressUpdate").value;

            $.ajax({
                method: "GET",
                url: "ajax-update-maitenance.php",
                data: {id: txtID,  fname: txtFnamme, lname: txtLname, mname: txtMname, contact: txtContact, bdate: txtBdate, address: txtAddress, action: 'user-update'},
                success: function(){
                    alert("Success");
                    location.reload();
                }
        ...
        function deleteUserInfo($id) {
            if (confirm("Are you sure you want to delete")) {
                ...
                $.ajax({
                    ...
                    data: {id: txtID, action: 'user-delete'},
                    success: function(){
                        alert("Success");
                        location.reload();
                    }
