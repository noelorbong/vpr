...
<body>
                                                    ...
                                                    if($objectMaintenance->selectWithJoin($sqlStatement) != 0) {
                                                        foreach ($objectMaintenance->selectWithJoin($sqlStatement) as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right">
                                                                    <button onclick="addNewViolation(<?php print $value["id"]?>)" type="button" class="btn btn-primary btn-gradient btn-sm">Add New Violation</button>
                                                                    <button onclick="viewViolation(<?php print $value["id"]?>)" type="button" class="btn btn-outline-primary btn-sm">View Violation</button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
    ...
    <div class="modal fade" id="exampleModalCenterUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Violation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="get">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Violation Name</label>
                            <textarea type="text" rows="3" class="form-control" id="txtViolationName"></textarea>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button onclick="addViolate()" class="btn btn-primary">Add Violation</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="exampleModalCenterView" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Violation/s</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        ...
        function viewViolation($id){
            var x = $id;
            $("#loadViolation").load("t-violation-list.php?x="+x);
        ...
        function addViolate() {
            ...
            var txtViolationName = document.getElementById("txtViolationName").value;

            $.ajax({
                method: "GET",
                url: "ajax-insert-maitenance.php",
                data: {id: Id, violation: txtViolationName, action: 'violation-add'},
                success: function(){
                    alert("Success");
                    location.reload();
                }
