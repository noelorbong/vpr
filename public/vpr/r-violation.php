...
<body>
									...
									<div class="row">
										<div class="col-lg-12 pb-5">
											...
											<div class="table-responsive">
                                                    ...
                                                    if($objectMaintenance->selectWithJoin($sqlStatement) != 0) {
                                                        foreach ($objectMaintenance->selectWithJoin($sqlStatement) as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php print $value["violation"]?></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    }
                                                ...
                                                <button type="button" class="btn btn-primary btn-gradient btn-sm" style="float: right" onclick="showFile()">PRINT REPORT</button>
    ...
    <script>
        ...
        function updateVehicle() {
            ...
            var txtPlateNumber = document.getElementById("txtPlateNumberUpdate").value;
            var txtVehicleDesc = document.getElementById("txtVehicleDescUpdate").value;

            $.ajax({
                method: "GET",
                url: "ajax-update-maitenance.php",
                data: {id: Id, platenumber: txtPlateNumber, vehicledesc: txtVehicleDesc , action: 'vehicle-update'},
                success: function(){
                    alert("Success");
                    location.reload();
                }
        ...
        function showFile(){
                window.open("fpdf181/tutorial/report-violation.php", "_blank", "menubar = 0");
        }
