							...
							<div class="card">
								...
								<div class="card-table table-responsive">
									<table class="table table-hover align-middle">
                                        ...
                                        <?php
                                        if($objectMaintenance->selectAllRecords("tbl_vehicle") != 0) {
                                            foreach ($objectMaintenance->selectAllRecords("tbl_vehicle") as $value) {
                                                ?>
                                                <tr>
                                                    <td class="text-left">
                                                        <span><?php print $value["plate_number"]?></span>
                                                    </td>
                                                    <td><?php print $value["vehicle_model"]?></td>
                                                    <td>
                                                        <button onclick="viewViolations(<?php print $value["id"]?>)" class="btn btn-primary btn-sm">View</button>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
